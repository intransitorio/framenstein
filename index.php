...
<body onload="$('.loader').removeClass('loading');">
  ...
  <div id="wrapper">
    ...
    <div id="content">
      <div class="jumbotron">
        <h1>Hello, world!</h1>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quia temporibus in pariatur, explicabo voluptates, ipsam nam at ut aut quaerat maxime sapiente, ipsa distinctio tempore, ducimus rerum vitae! Incidunt, vitae.</p>
        <p><a class="btn btn-primary btn-lg" href="#" role="button">Learn more</a></p>
      </div>
      <div class="row">
        <div class="col-xs-6 col-md-3">
          <a href="#" class="thumbnail">
            <img src="http://unsplash.it/900/600" alt="...">
          </a>
          <h1>
      ...
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img class="img-responsive" style="width: 100%;height: auto;" src="http://unsplash.it/900/600" alt="...">
            <div class="carousel-caption">
              <h1>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate praesentium maiores natus, inventore quia, facilis in eveniet aspernatur explicabo vero ullam ut quaerat hic similique accusamus maxime iste animi libero.
              </h1>
            </div>
          </div>
          <div class="item">
...
<body role="document">
  ...
  <div class="container theme-showcase" role="main">
    ...
    <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="data:image/svg+xml;base64," data-holder-rendered="true" style="width: 200px; height: 200px;">
  ...
  <!-- <script src="../../assets/js/docs.min.js"></script>  NOT FOUND-->
  <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
  <!-- <script src="../../assets/js/ie10-viewport-bug-workaround.js"></script> NOT FOUND-->
  <!-- NOT FOUND -->
